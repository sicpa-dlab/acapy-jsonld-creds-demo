...
T = TypeVar("T", bound="V20CredProposalRequestPreviewOpt")


@attr.s(auto_attribs=True)
class V20CredProposalRequestPreviewOpt:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v20_cred_proposal_request_preview_opt = cls(
            connection_id=connection_id,
            filter_=filter_,
        ...
        v20_cred_proposal_request_preview_opt.additional_properties = d
        return v20_cred_proposal_request_preview_opt
