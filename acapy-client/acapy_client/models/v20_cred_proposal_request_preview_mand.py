...
T = TypeVar("T", bound="V20CredProposalRequestPreviewMand")


@attr.s(auto_attribs=True)
class V20CredProposalRequestPreviewMand:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v20_cred_proposal_request_preview_mand = cls(
            connection_id=connection_id,
            credential_preview=credential_preview,
            filter_=filter_,
        ...
        v20_cred_proposal_request_preview_mand.additional_properties = d
        return v20_cred_proposal_request_preview_mand
